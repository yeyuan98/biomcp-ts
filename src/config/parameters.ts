...
export const ENV_PARAM_ROWS: readonly EnvParamRow[] = [
  ...
  { kind: 'env', id: 'ONCOKB_TOKEN', group: 'api-keys', classification: 'secret', effect: 'Required by the variant_oncokb tool (OncoKB annotations).', howToSet: 'Set ONCOKB_TOKEN in the client env block (request access at onckb.org).' },
