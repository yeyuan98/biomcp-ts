...
API abstraction layer for biomcp-ts. Provides protocol-aware HTTP clients, a source registry, connection lifecycle management, and rate limiting for 37 bioinformatics data sources.
...
| Category | Source IDs |
|---|---|
| Genomics | `mygene`, `myvariant`, `gtex`, `string`, `geo_soft`, `ensembl` |
| Proteins & Pathways | `uniprot`, `reactome`, `reactome_analysis` |
| Drugs & Pharmacology | `mychem`, `openfda` |
| Diseases | `mydisease`, `monarch` |
| Literature | `eutils`, `pubtator`, `europepmc`, `semantic_scholar`, `litsense`, `ncbi_idconv`, `pmc_oa`, `crossref`, `opencitations`, `biorxiv` |
